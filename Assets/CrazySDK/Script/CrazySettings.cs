...
namespace CrazyGames
{
    ...
    */
    ...
    {
        [SerializeField] private CloudInstaller cloudInstaller;
        
        public bool SiteLockEnable() {
            if(cloudInstaller != null)
            {
                switch (cloudInstaller.Type)
                {
                    case ECloudType.Yandex:
                    case ECloudType.GamePush:
                        return false;
                }
            }
            return true;
