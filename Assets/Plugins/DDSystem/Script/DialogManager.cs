...
namespace Plugins.DDSystem.Script
{
    public class DialogManager : MonoBehaviour
    {
        ...
        public TextMeshProUGUI Printer_CharacterName;
        ...
        public void Show(DialogData Data)
        {
            ...
            Printer_CharacterName.text = GetText(_current_Character.LocalizationNameKey);
        }

        private string GetText(string messageKey)
        {
            return ""; //TODO: get from localization
        }

        public void SetBackgroundTransparent(int value)
        {
        ...
        public void SetDelayForSkip(float delay)
        {
            if (delay <= 0)
            {
                Debug.LogError("Delay can't be lass or equal the 0!");
                return;
            }

            _delaybeforrSkip = true;
