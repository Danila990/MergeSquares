    ...
    public class EazySoundManager : MonoBehaviour
    {
        ...
        private void UpdateAllAudio(Dictionary<int, Audio> audioDict)
        {
            ...
            foreach (var key in keys)
            {
                ...
                if (!audio.IsPlaying && !audio.Paused || audio.AudioSource == null)
                {
        ...
        public int PrepareMusic(AudioClip clip, float volume, bool loop, Transform transform)
        {
            return PrepareAudio(Audio.AudioType.Music, clip, volume, loop, true, 1f, 1f, -1f, transform);
        }
        
        public int PrepareMusic(AudioClip clip, float volume, bool loop, Transform transform, bool ignoreDuplicate)
        {
            return PrepareAudio(Audio.AudioType.Music, clip, volume, loop, true, 1f, 1f, -1f, transform, ignoreDuplicate);
        }
        ...
        public int PrepareSound(AudioClip clip, float volume, bool loop, Transform sourceTransform, bool ignoreDuplicate)
        {
            return PrepareAudio(Audio.AudioType.Sound, clip, volume, loop, false, 0f, 0f, -1f, sourceTransform, ignoreDuplicate);
        }
        ...
        public int PrepareUISound(AudioClip clip, float volume, bool loop, Transform sourceTransform)
        {
            return PrepareAudio(Audio.AudioType.UISound, clip, volume, loop, false, 0f, 0f, -1f, sourceTransform);
        }
        
        public int PrepareUISound(AudioClip clip, float volume, bool loop, Transform sourceTransform, bool ignoreDuplicate)
        {
            return PrepareAudio(Audio.AudioType.UISound, clip, volume, loop, false, 0f, 0f, -1f, sourceTransform, ignoreDuplicate);
        }
        ...
        {
            return PrepareAudio(audioType, clip, volume, loop, persist, fadeInSeconds, fadeOutSeconds,
                currentMusicfadeOutSeconds, sourceTransform, GetAudioTypeIgnoreDuplicateSetting(audioType));
        }
        
        private int PrepareAudio(Audio.AudioType audioType, AudioClip clip, float volume, bool loop, bool persist, float fadeInSeconds, float fadeOutSeconds, float currentMusicfadeOutSeconds, Transform sourceTransform, bool ignoreDuplicate)
        {
            if (clip == null)
            {
