...
namespace Core.Gestures
{
    ...
    public class GestureController : MonoBehaviour
    {
        ...
        [SerializeField] private float maxTapDrift = 5.0f;
        ...
        [SerializeField] private float minSwipeDistance = 10.0f;

        // How much a swipe should consistently be in the same direction before it is considered a swipe.
        [SerializeField] private float swipeDirectionSamenessThreshold = 0.6f;

        [SerializeField] private float updateDelay = 0.08f;

        private float _updateDelayTimer;

        [Header("Debug"), SerializeField] private Text label;
